    ...
    class Meta:
        ...
        widgets = {
            ...
            "venue_address": forms.Textarea(
                attrs={
                    "class": "form-field-input",
                    "id": "client-event-venue-address",
                    "rows": 3,
                    "placeholder": "Venue address or notes",
                }
            ),
            "payment_method": forms.Select(
                attrs={
                    "class": "form-field-input",
                    "id": "client-event-payment-method",
                }
            ),
            "has_own_venue": forms.CheckboxInput(
                attrs={
                    "class": "form-check-input",
                    "id": "client-event-own-venue",
                }
            ),

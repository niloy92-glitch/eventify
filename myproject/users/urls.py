...
urlpatterns = [
    ...
    path(
        ...
        views.vendor_profile_update_view,
        name="vendor_profile_update",
    ),
    path(
        "vendor/profile/delete/",
        views.vendor_delete_account_view,
